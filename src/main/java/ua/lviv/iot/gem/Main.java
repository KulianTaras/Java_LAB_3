...
public class Main {
    public static void main(String[] args) {
        Gem diamond = new Gem(TransparencyLevel.HIGH, "Israel", 5200, 1.2, "Diamond",
                CleavageLevel.PERFECT);
        SemiPreciousStone amethyst = new SemiPreciousStone(TransparencyLevel.MIDDLE, "Russian", 1200,
                0.9, "Amethyst", Origin.NATURAL);
        NecklaceStone hanggam = new NecklaceStone(TransparencyLevel.ZERO, "Ukraine", 200,
                0.7, "Hanggam");
